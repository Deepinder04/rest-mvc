...
public class BeerServiceJPA implements BeerService {
    ...
    //TODO: ask how to cache it and use appropriate method for save
    @Override
    ...
    @Override
    @Cacheable(cacheNames = "beer", key = "#id", cacheManager = "cacheManager23hr")
    ...
    @Override
    @CachePut(cacheNames = "beer", key = "#beerId", cacheManager = "cacheManager23hr")
    ...
    @Override
    @CacheEvict(cacheNames = "beer", key = "#beerId", cacheManager = "cacheManager23hr")
