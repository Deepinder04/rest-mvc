...
class BeerControllerTest {
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        given(beerService.saveBeer(any())).willReturn(beerServiceImpl.listBeers(null, null, false).get(0));
    ...
    void testPatchBeer() throws Exception {
        BeerDTO mockedBeerDTO = beerServiceImpl.listBeers(null, null, false).get(0);
    ...
    public void testCreateNewBeer() throws Exception {
        BeerDTO mockBeerDTO = beerServiceImpl.listBeers(null, null, false).get(0);
